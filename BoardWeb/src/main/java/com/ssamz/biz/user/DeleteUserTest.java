...
public class DeleteUserTest {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * // JDBC 3단계 : Statement 생성 String sql = "delete users where id = ?"; stmt =
		 * conn.prepareStatement(sql);
		 * 
		 * // JDBC 4단계 : SQL 전송 // ? 값 설정 stmt.setString(1, "ssamz3");
		 * 
		 * // SQL 전송 int count = stmt.executeUpdate(); System.out.println(count +
		 * "건 데이터 처리 성공! 삭제"); } catch (SQLException e) { // TODO Auto-generated catch
